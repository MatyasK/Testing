/*
 * WARNING: This file has become obsolete and is only kept for fall-back use.
 */
...
//		/* END IGNORED CODE */
	...
	public void werknemerToevoegen() {
		...
		System.out.println("Geef de functie op [1=manager,2=boekhouder,4=oppasser]");
		int werknemerSoort = ReadInput.getInt("functie");
			...
			while (scanner.hasNextLine()) {
				...
				case 2: { // Medewerker toevoegen
					...
					default: // niet bestaande werknemer code
						System.err.println("Bogus categorie " + functie + " gevonden!");
						scanner.close();
						return;
